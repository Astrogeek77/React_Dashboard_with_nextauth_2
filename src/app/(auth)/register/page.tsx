  ...
  return (
    <section>
      <div className="grid grid-cols-1 lg:grid-cols-2 h-screen">
        <div className="relative items-end px-4 pb-10 sm:px-6 sm:pb-16 md:justify-center md:items-center lg:px-8 lg:pb-24 hidden md:flex">
          <div className="absolute inset-0 bg-black object-cover object-top"></div>
          <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent"></div>
          <div className="relative">
            <div className="w-full max-w-xl xl:mx-auto xl:w-full xl:max-w-xl xl:pr-24">
              <h3 className="text-4xl font-bold text-white">Astrogeek77</h3>
            </div>
          </div>
        </div>
        <div className="flex items-center justify-center px-4 sm:px-6 lg:px-8 mt-6">
